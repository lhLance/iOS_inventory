//
//  MonitorShapeButton.m
//  Fii
//
//  Created by yetao on 2019/4/11.
...
@implementation MonitorShapeButton
...
-(instancetype)initWithFrame:(CGRect)frame ButtonType:(ButtonType)type
{
    ...
    titleLabel.textColor=[UIColor colorWithRed:159/255.0
                                         green:159/255.0
                                          blue:167/255.0
                                         alpha:1];
...
- (void)longPressGesture:(UILongPressGestureRecognizer*)longGesture{
    ...
    if (longGesture.state==UIGestureRecognizerStateEnded||
        longGesture.state==UIGestureRecognizerStateCancelled||longGesture==nil) {
    ...
    if (containsPoint &&
        longGesture.state==UIGestureRecognizerStateEnded&&
