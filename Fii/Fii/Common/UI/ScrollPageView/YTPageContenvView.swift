...
/*
 ...
 2.闭包中的self不能省略
 */
protocol YTPageContenvViewDelegate: class {
...
class YTPageContenvView: UIView {
    //MARK:- 属性
    weak var delegate: YTPageContenvViewDelegate?
...
extension YTPageContenvView:UICollectionViewDataSource{
...
extension YTPageContenvView:UICollectionViewDelegate{
    //scrollView 减速完成
...
//MARK:- 遵守YTPageTitleViewDelegate
extension YTPageContenvView:YTPageTitleViewDelegate{
