...
class YTChageEmotionStrTool: NSObject {
    ...
    static func executeMatch() {
        ...
        let totalRange:NSRange = NSRange.init(location: 0, length: _string.count)
    ...
    static func setImageDataArray() {
        ...
        for i:Int in 0..<_matches.count {
            ...
            let attachMent:YTTextAttachment = YTTextAttachment()
