...
class SubView: UIView {
    ...
    func setupView() {
        ...
        btn.addTarget(self, action: #selector(theBtnTapped), for: UIControl.Event.touchUpInside)
        self.addSubview(btn)
        
        btn2.backgroundColor = UIColor.red
        btn2.addTarget(self, action: #selector(theBtn2Tapped), for: UIControl.Event.touchUpInside)
